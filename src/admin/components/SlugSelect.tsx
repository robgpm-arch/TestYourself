    ...
    <div>
      ...
      {mode === 'select' ? (
        <div className="flex gap-2">
          ...
          <button type="button" className="border rounded px-2" onClick={() => setMode('custom')}>
            Custom…
          </button>
        </div>
      ) : (
        <div className="flex gap-2">
          ...
          />
          <button type="button" className="border rounded px-2" onClick={() => setMode('select')}>
            Back
          </button>
        </div>
      )}
