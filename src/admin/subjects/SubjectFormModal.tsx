      ...
      <div className="w-full max-w-lg rounded-xl bg-white p-5 shadow-xl">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                disabled={!!initial?.name && initial?.boardId !== undefined}
              />
            </div>
            <div>
              ...
              <input
                ...
                disabled={!!initial?.name && initial?.examId !== undefined}
              />
            </div>
          </div>
        </div>
        ...
        <div className="mt-5 flex items-center justify-end gap-3">
          ...
          <button
            ...
            onClick={() => onSubmit({ name, order, enabled, mediumId, courseId, boardId, examId })}
          >
