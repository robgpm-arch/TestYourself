...
import {
  collection, onSnapshot, orderBy, query, where, QueryConstraint,
} from "firebase/firestore";

export type Course = { id: string; name: string; medium?: string; board?: string; examId?: string; order?: number; enabled?: boolean };
