...
const SUBJECT_PRESETS = [
  "Algebra","Geometry","Trigonometry","Arithmetic",
...
export function SubjectNameSelect({
  ...
  return (
    <div>
      <label className="block mb-1 text-sm font-medium">Subject <span className="text-red-600">*</span></label>
      <input
      ...
      <p className="mt-1 text-xs text-slate-500">
        Don't see it? Just type the name to create it.
      </p>
    </div>
  );
}