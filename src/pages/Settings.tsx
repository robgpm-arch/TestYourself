          ...
          >
            <ResponsiveGrid cols={{ default: 1, sm: 2, lg: 3 }} gap={6} className="mb-12">
              {settingsCategories.map((category, index) => (
                ...
                >
                  <div
                    className={`relative h-48 rounded-2xl bg-gradient-to-br ${category.color} ${category.hoverColor} shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden`}
                  >
                    {/* Card Content */}
                    <div className="relative z-10 h-full p-6 flex flex-col justify-between text-white">
                      <div className="flex justify-between items-start">
                        <IconGlow icon={category.icon} isSelected={selectedCard === category.id} />
                      ...
                      <div>
                        ...
                        <p className="text-white/90 text-sm leading-relaxed">{category.subtitle}</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        {['Light', 'Dark', 'Auto'].map(theme => (
                          <div
                            key={theme}
                            className="border-2 border-gray-200 rounded-xl p-4 hover:border-purple-400 cursor-pointer transition-colors"
                          >
                            <div className="text-center">
                              <div
                                className={`w-16 h-16 mx-auto mb-3 rounded-lg ${theme === 'Light' ? 'bg-white border' : theme === 'Dark' ? 'bg-gray-800' : 'bg-gradient-to-br from-white to-gray-800'}`}
                              ></div>
                      ...
                      <div>
                        ...
                        <div className="flex gap-3">
                          {[
                            ...
                            <div
                              key={color}
                              className={`w-10 h-10 ${color} rounded-full cursor-pointer hover:scale-110 transition-transform`}
                            ></div>
                          ))}
                        </div>
                      </div>
                        ...
                        {[
                          {
                            ...
                            subtitle: 'Get notified to maintain your study streak',
                          },
                          {
                            title: 'Quiz Alerts',
                            subtitle: 'New quizzes and practice sessions available',
                          },
                          {
                        ...
                        {[
                          {
                            ...
                            subtitle: 'Control who can see your profile and progress',
                          },
                          {
                            title: 'Data Sharing',
                            subtitle: 'Manage how your learning data is used',
                          },
                          {
                            title: 'Analytics',
                          ...
                          },
                          {
                            ...
                            subtitle: 'Control external app connections',
                          },
                        ].map((item, index) => (
                          <div
                            key={index}
