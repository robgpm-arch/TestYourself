...
const ChallengeResult: React.FC = () => {
    ...
    () => [
      {
        ...
        name: 'Kavya',
        avatar:
          'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=facearea&w=220&h=220&q=80',
        score: 1890,
        streak: 6,
      },
      {
      ...
      },
      {
        ...
        name: 'Amrita',
        avatar:
          'https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?auto=format&fit=facearea&w=220&h=220&q=80',
        score: 1715,
      },
      {
        id: 'p4',
  ...
  const podiumOrder: PodiumPlayer[] = [topThree[1], topThree[0], topThree[2]].filter(
    Boolean
  ) as PodiumPlayer[];
                  ...
                  <div className="podium-info">
                    ...
                    {player.streak && player.streak > 0 && index === 1 && (
                      <div className="podium-streak">
                        🔥 Streak Achieved! {player.streak} in a row
                      </div>
                    )}
                  </div>
                </motion.div>
